...
export class HomeLightRays {
    constructor(container, options = {}) {
        this.container = container;
        this.options = {
            raysColor: options.raysColor || '#ffffff',
            raysSpeed: options.raysSpeed || 0.1,
            lightSpread: options.lightSpread || 0.3,
            rayLength: options.rayLength || 7.0,
            mouseInfluence: options.mouseInfluence || 0.65,
            saturation: options.saturation || 1.2,
            fadeDistance: options.fadeDistance || 3.0,
