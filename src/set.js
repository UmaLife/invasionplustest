    ...
    <div class="footer-content">
        ...
        <div class="footer-links-group">
            ...
            <div class="footer-column">
                ...
                <ul>
                    ...
                    <li>
                        <a href="software.html#cases" onclick="softwareFooterClick('cases')">
                            Cases
                        </a>
                    </li>
                    <li>
                        <a href="software.html#coolers" onclick="softwareFooterClick('coolers')">
                        Coolers
                    </a>
        ...
        <div class="footer-social-section">
            ...
            <div class="social-icons">
                ...
                <a href="https://wa.me/60179848964">
...
<div class="floating-social">
    ...
    <div class="social-menu" id="socialMenu">
        ...
        <a href="https://wa.me/60179848964" target="_blank">
            <i class="fa-brands fa-whatsapp"></i>
        </a>
...
<!--Menu bar-->
    <div class="side-menu" id="sideMenu">
        ...
        <div class="menu-socials">
            ...
            <a href="https://wa.me/60179848964"><i class="fa-brands fa-whatsapp"></i></a>
            <a href="https://www.facebook.com/InvasionPlus" target="_blank">
                <i class="fa-brands fa-facebook"></i>
            </a>
            <a href="https://www.instagram.com/invasionplus" target="_blank">
...
function softwareFooterClick(category) {

    // If already on software.html
    if (window.location.pathname.endsWith("software.html")) {

        const button = document.querySelector(
            `.software-filter[data-filter="${category === 'cases' ? 'case' : 'cooler'}"]`
        );
